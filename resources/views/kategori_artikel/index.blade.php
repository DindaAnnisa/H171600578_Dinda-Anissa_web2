...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center bg-success" button class="btn btn-success">Kategori Artikel</div> 
                <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <a href="{!! route('kategori_artikel.show',[$item-> id]) !!}" button class="btn btn-dark">Lihat</a>
                        </td>
                        @endforeach
